...
####################################################################################################################        
        setting_edit_label = Label(main_part, text='IP 설정 편집', font=('Arial', 30), fg='white', bg='black')
        ...
        values = ['Manual', 'Auto']
        style = ttk.Style()
        style.configure('W.TCombobox',arrowsize = 30)
        ...
        combobox.config(font=('Arial', 30))
        combobox.option_add('*TCombobox*Listbox.font', ('Arial', 30))  # Set the font for the list items

        combobox.set('Auto')
        combobox.grid(row=0, column=0, sticky='NEWS')
####################################################################################################################
        IPv4_label = Label(main_part, text='IPv4', font=('Arial', 30), fg='white', bg='black')
...
####################################################################################################################
        IPv6_label = Label(main_part, text='IPv6', font=('Arial', 30), fg='white', bg='black')
...
####################################################################################################################        
        ...
        complete_label = Label(complete_frame, text='Complete',font=('Arial', 30), bd=None, borderwidth=0, border=0, bg='black', fg='white')
